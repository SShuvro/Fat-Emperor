    ...
    ! function() {
        ...
        c.prototype.init = function() {
            ...
            var d = 1,
                e = function(c) {
                    var d, e, f = b.core.$outer.find(".lg-current .lg-image"),
                        g = (a(window).width() - f.width()) / 2,
                        h = (a(window).height() - f.height()) / 2 + a(window).scrollTop();
            ...
            b.core.$slide.on("mousedown.lg.zoom", function(d) {
                ...
                h = f.outerHeight() * f.attr("data-scale") > b.core.$outer.find(".lg").height(), g = f.outerWidth() * f.attr("data-scale") > b.core.$outer.find(".lg").width(), b.core.$outer.hasClass("lg-zoomed") && a(d.target).hasClass("lg-object") && (g || h) && (d.preventDefault(), c = {
                    x: d.pageX,
                    y: d.pageY
